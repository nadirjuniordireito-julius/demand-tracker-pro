...
export default function DashboardPageOperador() {
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-3xl font-bold tracking-tight">{t('dashboard.titleOperador')}</h1>
        </div>
        <p className="text-sm font-light text-muted-foreground">{t('dashboard.descriptionOperador')}</p>
      </div>
